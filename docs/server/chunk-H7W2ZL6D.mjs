...
// src/app/authen.service.ts
var _AuthenService = class _AuthenService {
  constructor(httpService) {
    this.httpService = httpService;
    this.url = "http://localhost:8000/auth/";
    this.url2 = "http://localhost:8000/products";
  }
...
_AuthenService.\u0275fac = function AuthenService_Factory(t) {
  return new (t || _AuthenService)(\u0275\u0275inject(HttpClient));
};
_AuthenService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _AuthenService, factory: _AuthenService.\u0275fac, providedIn: "root" });
var AuthenService = _AuthenService;
...
var _HomeComponent = class _HomeComponent {
  constructor(autheService) {
    ...
    this.p = 1;
    this.list = ["S\u1EA3n Ph\u1EA9m 1", "S\u1EA3n Ph\u1EA9m 2", "S\u1EA3n Ph\u1EA9m 3", "S\u1EA3n Ph\u1EA9m 4", "S\u1EA3n Ph\u1EA9m 5"];
  }
  ngOnInit() {
    this.autheService.getAllProduct().subscribe((data) => {
      console.log(data);
    }, (error) => {
      console.log(error);
    });
...
_HomeComponent.\u0275fac = function HomeComponent_Factory(t) {
  return new (t || _HomeComponent)(\u0275\u0275directiveInject(AuthenService));
};
_HomeComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 6, consts: [[4, "ngFor", "ngForOf"], [3, "pageChange"]], template: function HomeComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", \u0275\u0275pipeBind2(4, 1, ctx.list, \u0275\u0275pureFunction1(4, _c02, ctx.p)));
  }
...
_RegisterComponent.\u0275fac = function RegisterComponent_Factory(t) {
  return new (t || _RegisterComponent)(\u0275\u0275directiveInject(AuthenService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ToastrService));
};
_RegisterComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterComponent, selectors: [["app-register"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 1, consts: [["formLogin", "ngForm"], ["class", "alert alert-danger", "role", "alert", 4, "ngIf"], [3, "ngSubmit"], ["type", "email", "ngModel", "", "name", "email", 1, "form-control"], ["type", "password", "ngModel", "", "name", "password", 1, "form-control"], ["type", "submit", 1, "btn", "btn-info"], ["role", "alert", 1, "alert", "alert-danger"]], template: function RegisterComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("ngSubmit", function RegisterComponent_Template_form_ngSubmit_3_listener() {
      ...
      return \u0275\u0275resetView(ctx.onSubmit(formLogin_r3));
    });
...
var canActivateProduct = (route, state2) => {
